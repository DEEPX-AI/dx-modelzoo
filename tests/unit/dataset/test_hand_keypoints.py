"""Tests for dx_modelzoo.dataset.hand_keypoints."""

import pytest

from dx_modelzoo.dataset.hand_keypoints import HandKeypoints
...
class TestHandKeypoints:
    ...
    def test_init_with_fake_path(self):
        ...
        try:
            ds = HandKeypoints("/nonexistent/path")
    ...
    def test_is_dataset_base(self):
        ...
        assert issubclass(HandKeypoints, DatasetBase)
