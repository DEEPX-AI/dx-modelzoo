"""Tests for dx_modelzoo.evaluator.instance_segmentation_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.instance_segmentation_evaluator import InstanceSegmentationEvaluator
...
class TestInstanceSegmentationEvaluator:
    def _make(self):
        return InstanceSegmentationEvaluator(FakeSession(), FakeDataset())
