"""Tests for dx_modelzoo.evaluator.object_detection_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.object_detection_evaluator import ObjectDetectionEvaluator
...
class TestObjectDetectionEvaluator:
    def _make(self):
        return ObjectDetectionEvaluator(FakeSession(), FakeDataset())
