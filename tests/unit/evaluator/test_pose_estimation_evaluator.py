"""Tests for dx_modelzoo.evaluator.pose_estimation_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.pose_estimation_evaluator import PoseEstimationEvaluator
...
class TestPoseEstimationEvaluator:
    def _make(self):
        return PoseEstimationEvaluator(FakeSession(), FakeDataset())
