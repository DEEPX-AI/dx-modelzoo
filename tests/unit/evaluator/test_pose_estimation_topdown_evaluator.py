"""Tests for dx_modelzoo.evaluator.pose_estimation_topdown_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.pose_estimation_topdown_evaluator import PoseEstimationTopDownEvaluator
...
class TestPoseEstimationTopDownEvaluator:
    def _make(self):
        return PoseEstimationTopDownEvaluator(FakeSession(), FakeDataset())
