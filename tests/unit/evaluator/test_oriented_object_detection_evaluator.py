"""Tests for dx_modelzoo.evaluator.oriented_object_detection_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.oriented_object_detection_evaluator import OBBEvaluator
...
class TestOBBEvaluator:
    def _make(self):
        return OBBEvaluator(FakeSession(), FakeDataset())
