"""Tests for dx_modelzoo.evaluator.hand_detection_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.hand_detection_evaluator import HandDetectionEvaluator
...
class TestHandDetectionEvaluator:
    def _make(self):
        return HandDetectionEvaluator(FakeSession(), FakeDataset())
