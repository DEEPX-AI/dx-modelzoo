"""Tests for dx_modelzoo.evaluator.keypoint_detection_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.keypoint_detection_evaluator import KeypointDetectionEvaluator
...
class TestKeypointDetectionEvaluator:
    def _make(self):
        return KeypointDetectionEvaluator(FakeSession(), FakeDataset())
