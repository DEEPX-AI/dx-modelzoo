"""Tests for dx_modelzoo.evaluator.object_pose_estimation_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.object_pose_estimation_evaluator import ObjectPoseEstimationEvaluator
...
class TestObjectPoseEstimationEvaluator:
    def _make(self):
        return ObjectPoseEstimationEvaluator(FakeSession(), FakeDataset())
