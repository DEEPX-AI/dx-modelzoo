"""Tests for dx_modelzoo.evaluator.zero_shot_instance_segmentation_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.zero_shot_instance_segmentation_evaluator import ZeroShotInstanceSegmentationEvaluator
...
class TestZeroShotInstanceSegmentationEvaluator:
    def _make(self):
        return ZeroShotInstanceSegmentationEvaluator(FakeSession(), FakeDataset())
