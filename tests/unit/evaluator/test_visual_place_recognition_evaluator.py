"""Tests for dx_modelzoo.evaluator.visual_place_recognition_evaluator."""

import numpy as np

from dx_modelzoo.common.dataloader import DatasetBase
from dx_modelzoo.evaluator.visual_place_recognition_evaluator import VisualPlaceRecognitionEvaluator
...
class TestVisualPlaceRecognitionEvaluator:
    def _make(self):
        return VisualPlaceRecognitionEvaluator(FakeSession(), FakeDataset())
