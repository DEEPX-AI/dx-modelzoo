...
See the [YAML Configuration Guide](source/guides/yaml-config.md) for complete details and examples.
...
| Topic | Link |
|-------|------|
| Installation | [source/getting-started/installation.md](source/getting-started/installation.md) |
| Quick Start | [source/getting-started/quickstart.md](source/getting-started/quickstart.md) |
| YAML Configuration | [source/guides/yaml-config.md](source/guides/yaml-config.md) |
| Model Evaluation | [source/guides/evaluation.md](source/guides/evaluation.md) |
| Custom Models | [source/guides/custom-models.md](source/guides/custom-models.md) |
| Architecture | [source/architecture/overview.md](source/architecture/overview.md) |
| Registry & Custom Ops | [source/architecture/registry.md](source/architecture/registry.md) |
