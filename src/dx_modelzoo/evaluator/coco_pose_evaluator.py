...
class COCOPoseEvaluator(EvaluatorBase):
    ...
    def _change_scales_to_origin(
        ...
        cloned_keypoints[..., 0] /= ratios
        cloned_keypoints[..., 1] /= ratios
    ...
    def _make_coco_format_pose(
        self, boxes: torch.Tensor, scores: torch.Tensor, class_ids:torch.Tensor, keypoints:torch.Tensor, img_id: torch.Tensor
    ) -> str:
        detections = []
