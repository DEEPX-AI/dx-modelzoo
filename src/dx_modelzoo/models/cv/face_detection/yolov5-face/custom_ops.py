"""YOLO face detection postprocessing custom ops.

Shared by yolov5-face and yolov7-face models.
"""
...
@POSTPROCESSING_REGISTRY.register("yolo_face_decode")
class YoloFaceDecode:
    """YOLOv5/v7 face detection decoder.

    Output formats differ from standard YOLO (landmarks between box and class):
