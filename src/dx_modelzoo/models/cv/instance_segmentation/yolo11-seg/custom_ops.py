"""YOLO11-seg instance segmentation postprocessing."""
...
@POSTPROCESSING_REGISTRY.register("yolo11_seg_decode")
class YOLO11SegDecode:
    """YOLO11-seg postprocessing with mask decoding.
