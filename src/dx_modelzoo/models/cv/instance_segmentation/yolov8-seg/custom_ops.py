"""YOLOv8-seg instance segmentation postprocessing."""
...
@POSTPROCESSING_REGISTRY.register("yolov8_seg_decode")
class YOLOv8SegDecode:
    """YOLOv8-seg postprocessing with mask decoding.
