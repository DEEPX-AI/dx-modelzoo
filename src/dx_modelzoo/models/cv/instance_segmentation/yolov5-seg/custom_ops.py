"""YOLOv5-seg instance segmentation postprocessing."""
...
@POSTPROCESSING_REGISTRY.register("yolov5_seg_decode")
class YOLOv5SegDecode:
    """YOLOv5-seg postprocessing with mask decoding.
