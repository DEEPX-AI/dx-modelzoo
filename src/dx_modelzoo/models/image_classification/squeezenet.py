...
class SqueezeNet1_0(ModelBase):
    info = ModelInfo(
        name="SqueezeNet1_0",
        dataset=DatasetType.imagenet,
        evaluation=EvaluationType.image_classification,
        raw_performance="58.09 80.42",
        q_lite_performance="57.07 79.93",
    )
...
class SqueezeNet1_1(ModelBase):
    info = ModelInfo(
        name="SqueezeNet1_1",
        dataset=DatasetType.imagenet,
        evaluation=EvaluationType.image_classification,
        raw_performance="58.18 80.61",
        q_lite_performance="57.60 80.13",
    )
